...
function OptionsPanel:Constructor ()
    ...
    self.WidthScrollBar.ValueChanged = function()
        self.WidthTitle:SetText("Largeur de la fenêtre : "..tostring(self.WidthScrollBar:GetValue()))
    end
    ...
    self.HeightScrollBar.ValueChanged = function()
        self.HeightTitle:SetText("Hauteur des effets : "..tostring(self.HeightScrollBar:GetValue()))
    end
    ...
    self.DebuffsTitle:SetText("Effets et affaiblissements")
    ...
    self.RevertButton:SetText("Annuler");
    ...
    self.DefaultButton:SetText("Par défaut");
    ...
    self.AcceptButton:SetText("Accepter");
