...
DEFAULT_FREEP_EFFECTS =  {
    {"Commun",      "Dazed",                                    1, 2},
    {"Commun",      "Force Attack",                             1, 0},
    {"Commun",      "Recovering",                               0, 0},
    {"Commun",      "Stunned",                                  1, 0},
    {"Commun",      "Rooted",                                   1, 2},
    {"Commun",      "Temporary State Immunity",                 1, 0},
    {"Beornide",    "Bash",                                     0, 0},
    ...
    {"Cambrioleur",     "Addle",                                    0, 0},
    {"Cambrioleur",     "Cunning Attack",                           0, 0},
    {"Cambrioleur",     "Damaging Gamble",                          0, 0, "Damaging Gamble"},
    {"Cambrioleur",     "Debuffing Gamble",                         0, 0, "Debuffing Gamble"},
    {"Cambrioleur",     "Gambler's Advantage",                      0, 0, "Gambler's Advantage"},
    {"Cambrioleur",     "Hedged Bet",                               0, 0, "Hedged Bet"},
    {"Cambrioleur",     "Provoke",                                  0, 0},
    {"Cambrioleur",     "Quite A Snag",                             0, 0, {"A Small Snag", "Quite A Snag"}},
    {"Cambrioleur",     "Reveal Weakness",                          0, 1},
    {"Cambrioleur",     "Trick: Counter Defence",                   0, 0},
    {"Cambrioleur",     "Trick: Dust in the Eyes",                  0, 0},
    {"Cambrioleur",     "Trick: Enraged (Trick)",                   0, 0, "Trick: Enraged %(Trick%)"},
    {"Cambrioleur",     "Trick: Disable",                           0, 0},
    ...
    {"Gardien",    "Take to Heart",                            0, 1},
    {"Gardien",    "Marked by Light",                          0, 1},
    {"Gardien",    "Slashing Wound",                           0, 0},
    {"Gardien",    "War-Chant",                                0, 0, "War%-Chant"},
    {"Gardien",    "Haemorrhaging Wound",                      0, 0},
    {"Gardien",    "Deep Wound",                               0, 0},
    {"Gardien",    "Terrible Wound",                           0, 0},
    {"Gardien",    "Staggered",                                0, 0},
...
DEFAULT_FREEP_PLAYER_EFFECTS = {
    {"Commun", "Temporary State Immunity",                      0, 0},
    {"Beornide", "Temporary State Immunity",                      0, 0},
    {"Cambrioleur", "Temporary State Immunity",                      0, 0},
    {"Capitaine", "Temporary State Immunity",                      0, 0},
    {"Champion", "Temporary State Immunity",                      0, 0},
    {"Gardien", "Temporary State Immunity",                      0, 0},
    {"Maitre-du-savoir", "Temporary State Immunity",                      0, 0},
    {"Menestrel", "Temporary State Immunity",                      0, 0},
    {"Gardien-des-runes", "Temporary State Immunity",                      0, 0},
    {"Sentinelle", "Temporary State Immunity",                      0, 0},
}
